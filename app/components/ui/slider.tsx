...
>(({ className, trackClassName, rangeClassName, thumbClassName, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className={cn("block h-4 w-4 rounded-full border-2 border-primary bg-background ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer", thumbClassName)} />
  </SliderPrimitive.Root>
))
